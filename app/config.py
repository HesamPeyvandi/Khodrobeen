...
class Settings:
    ...
    # respond. Real production evidence: the underlying calculation
    # genuinely takes 10-15s under normal conditions, and 30s (the old
    # Playwright default) still wasn't enough under network stress - keep
    # this generous.
    estimate_navigation_timeout_ms: int = _get_int("ESTIMATE_NAVIGATION_TIMEOUT_MS", 45000)
